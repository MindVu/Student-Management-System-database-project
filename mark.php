<?php
session_start();
if(isset($_GET['Stuid']) && !empty(trim($_GET['Stuid'])) && isset($_GET['Classid']) && !empty(trim($_GET['Classid'])))
{
          ...
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card" style="border-radius: 15px;">
              <div class="card-body p-5">
                  <form action="includes/mark.inc.php" method="post">
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $StuID; ?>" name="StuID"/>
                    <div class="pt-1 mb-4">
                      <button class="btn btn-dark btn-lg btn-block" type="submit" name="marking">Xác nhận</button>
                    </div>
                  </form>
