          ...
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card" style="border-radius: 15px;">
              <div class="card-body p-5">
                  <form action="includes/addtoclass.inc.php" method="post">

                    <h2 class="fw-normal mb-3 pb-3 text-center" style="letter-spacing: 1px; font-weight: 900;color:#060640;">Thêm sinh viên
                    </h2>
                ...
                ?>
                    ...
                    <div class="form-outline mb-4">
                      <input type="number" name="StuID" id="form2Example17" class="form-control form-control-lg" />
                      <label class="form-label" for="form2Example17">Mã sinh viên</label>
              </div>
              <input type="hidden" value="<?php echo $id; ?>" name="ClassID"/>
                    <div class="pt-1 mb-4">
                      <button class="btn btn-dark btn-lg btn-block" type="submit" name="addtoclass-submit">Xác nhận</button>
                    </div>
                  </form>
